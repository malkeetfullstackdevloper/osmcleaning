      ...
      <section className="py-5 bg-light">
        <Container>
            <Row className="mb-5">
                ...
                <Col lg={4} md={4} sm={12} className="endmain">
                  <img className="card-img-top card-img-small" src="/images/end-of-lease-cleaning.jpg" />
                </Col>
                <Col lg={8} md={8} sm={12} className="endmain">
            ...
            <Row className="mt-5 mb-5">
                <Col lg={4} md={4} sm={12} className="endmain">
                  <img className="card-img-top card-img-small" src="/images/carpet_steam_cleaning.webp" />
                </Col>
                <Col lg={8} md={8} sm={12} className="endmain">
